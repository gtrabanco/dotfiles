...
#
# Copied from there and customized
...
#
# Safari/WebKit/WebServices
#

# Default Web Search
defaults write -g NSPreferredWebServices '{
  NSWebServicesProviderWebSearch = {
    NSDefaultDisplayName = StartPage;
    NSProviderIdentifier = "com.startpage.www";
  };
}'
