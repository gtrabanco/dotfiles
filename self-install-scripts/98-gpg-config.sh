...
if platform::command_exists keybase &&\
   platform::command_exists gpg &&\
   platform::command_exists git &&
   output::yesno "Do you want to configure a Keybase GPG key with GIT"; then
  output::empty_line
  output::empty_line
